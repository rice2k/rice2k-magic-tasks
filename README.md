...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-3.1.0-e83f8f">
...
The v3.1.0 release includes:

- `Rice2k-Magic-Tasks-v3.1.0.exe` - single-file Windows app.
- `Rice2k-Magic-Tasks-v3.1.0.zip` - release package.
- `Rice2k-Magic-Tasks-v3.1.0.sha256` - checksum file.
- `Rice2k-Magic-Tasks-Source-v3.1.0.zip` - source archive.
...
1. Open `Rice2k-Magic-Tasks-v3.1.0.exe`.
...
```powershell
Get-FileHash .\Rice2k-Magic-Tasks-v3.1.0.exe -Algorithm SHA256
```
